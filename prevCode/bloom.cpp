...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int woodTexture      = loadTexture("pic/wood.jpg", true); // note that we're loading the texture as an SRGB texture
    unsigned int containerTexture = loadTexture("pic/container2.png", true); // note that we're loading the texture as an SRGB texture
