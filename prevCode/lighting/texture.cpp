...
int main() {
    ...
    Shader lightingCubeShader("./shaders/shader.vs", "./shaders/lightshader.fs");

    // initialize VAO and VBO of "the box"
    ...
    // initialize VAO of light source
    ...
    unsigned int spectularMap = loadTexture("./pic/container2_specular.png");
//    unsigned int emissionMap = loadTexture("./pic/matrix.jpg");
...
//    lightingShader.setInt("material.emission", 2);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glBindTexture(GL_TEXTURE_2D, spectularMap);
