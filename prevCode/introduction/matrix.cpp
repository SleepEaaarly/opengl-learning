...
int main() {
    ...
    // active before bind (texture0 is activated defaultly)
    ...
    ourShader.use();
    ourShader.setFloat("mixCoef", mixCoef);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniformMatrix4fv(glGetUniformLocation(ourShader.ID, "transform"), 1, false, glm::value_ptr(trans));
        ...
        glUniformMatrix4fv(glGetUniformLocation(ourShader.ID, "transform"), 1, false, glm::value_ptr(trans1));
