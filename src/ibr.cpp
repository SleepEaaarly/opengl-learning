...
int main()
{
    ...
    // --------------------------
    unsigned int ironAlbedoMap    = loadTexture("pic/rusted_iron/albedo.png");
    unsigned int ironNormalMap    = loadTexture("pic/rusted_iron/normal.png");
    unsigned int ironMetallicMap  = loadTexture("pic/rusted_iron/metallic.png");
    unsigned int ironRoughnessMap = loadTexture("pic/rusted_iron/roughness.png");
    unsigned int ironAOMap        = loadTexture("pic/rusted_iron/ao.png");
